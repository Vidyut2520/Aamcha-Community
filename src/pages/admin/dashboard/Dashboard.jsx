...
import { collection, count, getCountFromServer, query } from 'firebase/firestore';
        ...
        <Layout>
            <div className="py-10">
                <div
                    ...
                    <div className="left">
                        <img
                            className=" w-40 h-40  object-cover rounded-full border-2 border-green-400 p-1"
                    ...
                    <div className="right">
                        ...
                        <h2
                            style={{ color: mode === 'dark' ? 'white' : 'black' }} className="font-semibold">app.evidyut@gmail.com
                        </h2>
                        {/* <h2
                            style={{ color: mode === 'dark' ? 'white' : 'black' }} className="font-semibold">
                            <span>Total Blog : </span>  {getAllBlog.length > 0 ? <>{getAllBlog.map((index) => {
